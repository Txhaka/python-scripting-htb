...
# Simple python script whit a register account function which performs 50 account register on the webpage of# the Overflow machine in HTB, in order to see if there is any relation between the username and cookie 
